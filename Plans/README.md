...
|---|------|------------------|------------|
| 0 | [Audit](00-audit.md) | Findings with file:line — the evidence the rest of the plan is built on | — |
| 1 | [Tooling & build](01-tooling.md) | `package.json`, TypeScript, bundler, lint, `dist/` output | — |
| 2 | [Shared contracts](02-contracts.md) | Typed messages, one config source of truth, structured board state | 1 |
| 3 | [Site adapters](03-site-adapters.md) | `SiteAdapter` per site; kills the 8 repeated if-chains | 2 |
| 4 | [Popup decomposition](04-popup.md) | `popup.js` split into engine client / parser / view / autoplay | 2 |
| 5 | [Python backend](05-python-backend.md) | One backend instead of two drifted copies; typed; engine access made safe | — |
| 6 | [Verification](06-verification.md) | Tests for the pure logic + a manual smoke checklist | 1 |
